...
public class A16_BankersAlgorithm {
    ...
    public A16_BankersAlgorithm(int[][] allocation, int[][] max, int[] available) {
    ...
    public static void main(String[] args) {
        ...
        A16_BankersAlgorithm banker = new A16_BankersAlgorithm(allocation, max, available);
